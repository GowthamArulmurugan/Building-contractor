...
$qry=mysqli_query($conn,"insert into contractor(name,gender,age,email,phone,location,address,uname,psw) values('$name','$gender','$age','$email','$phone','$loc','$address','$uname','$psw')");
	if($qry)
	{
...
<form id="f1" name="f1" method="post" action="#">
  <table width="36%" border="0" align="center">	
    <tr>
          <td colspan="2"  align="center" ><div class="style5"><h3>New contractor Registation</h></div></td>
    </tr>
    <tr>
      <td width="38%">Name</td>
